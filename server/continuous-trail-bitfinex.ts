...
const JUMP_PCT         = 0.03;   // reverted from 0.01% 2026-09-03 — that was too sensitive, 23 trades/3 wins (13%)/-$0.46, clearly worse. Trying 0.03% (less sensitive than the original 0.02% too).
const ROLL_MS          = 2000;
