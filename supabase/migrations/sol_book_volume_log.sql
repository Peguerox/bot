...
CREATE TABLE IF NOT EXISTS sol_book_volume_log (
  ...
  bitstamp_bid DECIMAL(20,8),
  bitstamp_ask DECIMAL(20,8) -- strongest candidate from the earlier lead-lag research (73.3% match rate) -- never built into anything until now
);
