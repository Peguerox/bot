// MFE (Max Favorable Excursion) audit — for every trade, tracks the BEST unrealized gain
// reached mid-trade, then compares it to the actual final exit pnl. If trades regularly peak
// much higher than where they eventually exit, a trailing stop could capture more of the
// upside instead of giving it back waiting for the lagging trend-reversal exit signal.
// Runs on top of the -6% stop-loss baseline. Read-only, does not touch live bots.
