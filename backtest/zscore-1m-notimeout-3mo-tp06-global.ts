// Z-score strategy, 1-min high/low execution, NO max-hold timeout (TP/SL only, two outcomes).
// BCH, LINK, BTC, BNB, ADA, XRP, SOL, ETH. 3 months, Binance Global, 0% fee.
...
(async () => {
  ...
  const coins = ["BCH","LINK","BTC","BNB","ADA","XRP","SOL","ETH"];
  const results: any[] = [];
  ...
  console.log(`\nZ-score, 1-min HL execution, NO timeout (TP/SL only) · 3 months · Binance Global · 0% fee\n`);
