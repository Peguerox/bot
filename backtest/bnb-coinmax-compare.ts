...
const COIN_MAXES = [0.0005, 0.001, 0.002, 0.003]; // 0.05%, 0.1%, 0.2%, 0.3%
...
(async () => {
  ...
  console.log(`Pure-Lag BNB · BTC≥0.1% · TP=0.8% · SL=0.15% · 1m · 1 month · Binance.US\n`);
  console.log(`${"BNB filter".padEnd(12)} ${"PnL".padStart(8)}  ${"Ret%".padStart(7)}  ${"Trades".padStart(6)}  ${"T/day".padStart(5)}  ${"WR%".padStart(6)}  ${"PF".padStart(5)}  ${"MaxDD".padStart(6)}  ${"EndBal".padStart(8)}`);
