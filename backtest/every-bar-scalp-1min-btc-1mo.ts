...
// Applies a round-trip cost (fee + slippage) to every trade, deducted at exit. BTCFDUSD, 3mo.
...
(async () => {
  ...
  console.log(`\nBTCFDUSD every-bar (no filter) · 1-MIN entries · ${MONTHS}mo · TP=${TP_PCT}%/SL=${SL_PCT}%\n`);
