// Window=5 z-score strategy on BCHFDUSD, 2 years, same execution method as the live BCH bot
...
(async () => {
  ...
  process.stdout.write(`Fetching ${symbol} 1m (2yr, will take a while)... `);
  ...
  console.log(`\nBCHFDUSD z-score window=5 · 1yr · 1-min HL execution · no timeout · TP=0.8%/SL=0.3%\n`);
