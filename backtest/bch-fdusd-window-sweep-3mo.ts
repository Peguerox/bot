// Same window sweep (50/30/10/5) on BCHFDUSD but 3 months, to check if the shrinking-window
// trend from the 1mo test holds up or was overfitting to that specific month.
...
(async () => {
  ...
  console.log(`\nBCHFDUSD z-score window sweep · 3mo · 1-min HL execution · no timeout · TP=0.8%/SL=0.3%\n`);
  for (const zw of [5, 2, 1]) {
