// Window=5 z-score strategy on BTCFDUSD, 2 years, same execution method as the live BCH bot
...
(async () => {
  ...
  process.stdout.write(`Fetching ${symbol} 1m (5yr, will take a while)... `);
  ...
  console.log(`\nBTCFDUSD z-score window=5 · 5yr · 1-min HL execution · no timeout · TP=0.8%/SL=0.3%\n`);
