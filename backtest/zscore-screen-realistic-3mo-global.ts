// Realistic (high/low-aware) execution, 15-coin screen, 3 months, Binance GLOBAL data.
...
(async () => {
  ...
  console.log(`\nSingle-asset Z-score vs USDT · 3mo · Binance GLOBAL · realistic HL execution · 0% fee\n`);
