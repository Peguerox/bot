// Z-score strategy, 1-min high/low execution, NO timeout, TP=0.8%/SL=0.3%. BCH only, 1 year.
...
(async () => {
  ...
  process.stdout.write(`Fetching ${symbol} 1m (1yr, this will take a while)... `);
  ...
  console.log(`\nBCH z-score, 1-min HL execution, NO timeout, TP=0.8%/SL=0.3% · 1yr · Binance Global · 0% fee\n`);
