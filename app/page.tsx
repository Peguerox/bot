...
function formatAction(a: any): string {
  ...
  if (a.action === "LIMIT_BUY_PLACED")    return `BUY LIMIT  qty=${a.qty}  @$${a.price}  z=${parseFloat(a.z).toFixed(2)}`;
  ...
  return (
    <div className="bg-gray-900 rounded-xl p-5 space-y-5 flex flex-col">
      <div className="space-y-1.5">
        ...
        <p className="text-gray-500 text-xs">XLM/USDT · $25 · 1m · Z=1.5 · TP 0.8% · SL 0.3% · limit orders</p>
      </div>
